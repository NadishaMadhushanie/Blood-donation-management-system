    ...
    return (
        <ScrollView>
                ...
                <View style={styles.container}>
                    ...
                    <Text style={styles.boldText2}>
                        ...
                        <Text style={styles.boldText3}>
                             පසු පිටෙහි ඇති රුධිර දායක පත්‍රිකාව සම්පූර්ණ කිරීමට පෙර මෙම උපදෙස් මාලාව හොදින් කියවන්නx
                            {"\n"}
                            {"\n"}
                        </Text>
            ...
            <TouchableOpacity
                                ...
                                onPress={() => navigation.navigate('Donor Form')}
                            >
                                <Text style={{
                                    fontSize: 22,
                                    fontWeight: 'bold', 
                                ...
                                }}>Blood donor expression and report</Text>
            </TouchableOpacity>
